...
contactSurfacesValPrimary=2:2:(2*(n-1));
contactSurfacesValSecondary=3:2:((2*(n-1))+1);

contactSurfacesStringPrimary=strings(1,n-1);
contactSurfacesStringSecondary=strings(1,n-1);
