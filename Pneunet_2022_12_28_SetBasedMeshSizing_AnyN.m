...
for i=1:1:Length
    ...
    itemp=itemp-(chamber_count*((2*Chamber_wt_elements)+Chamber_length_elements+Gap_length_elements));
        ...
        elseif itemp <= Gap_length_elements+(3*Chamber_wt_elements)+Chamber_length_elements
            V_length(i)=current_length+(Chamber_wt*(1/Chamber_wt_elements));

        elseif itemp <= Gap_length_elements+(3*Chamber_wt_elements)+(2*Chamber_length_elements)
            V_length(i)=current_length+(Chamber_length*(1/Chamber_length_elements));

        elseif itemp <= Gap_length_elements+(4*Chamber_wt_elements)+(2*Chamber_length_elements) 
            V_length(i)=current_length+(Chamber_wt*(1/Chamber_wt_elements));
