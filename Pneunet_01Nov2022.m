...
h_c=5; %height of the pneunet chambers (mm) from the base
l_c=7; %length of the pneuent chamber (mm)
h_nc=2; %height of the gap between chambers (mm)
...
c=1; %Shear-modulus-like parameter
m_nl=2; %Material parameter setting degree of non-linearity
k_bm=c*k_factor; %Bulk modulus
...
%Get pressure faces
InnerFaceMinC=max(C)-2;
F_pressure=F(C>=InnerFaceMinC,:); 
...
febio_spec.Material.material{1}.c1=c;
febio_spec.Material.material{1}.m1=m_nl;
% febio_spec.Material.material{1}.c2=c;
% febio_spec.Material.material{1}.m2=-m_nl;
febio_spec.Material.material{1}.k=k_bm;
