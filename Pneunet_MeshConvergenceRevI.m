...
%% Load Inputs
%Load
designPressureAngle=0.015; %(MPa)-target pressure for required bend
designPressureForce=0.02; %0.1
...
mc(3)=plot(pointSpacingList,MaxTipForceTotalSc,'k');
legend(mc,{'Angle (node)','Angle (normal)', 'Force (total)'});
title('Mesh Covergence (% of result of iteration 1)')

%%
cFigure;
mc(1)=plot(1./pointSpacingList,MaxBendAngNodesSc,'r-');
hold on;
mc(2)=plot(1./pointSpacingList,MaxBendAngNormalsSc,'g-');
%mc(3)=plot(pointSpacingList,MaxTipForceMeanSc,'y-');
mc(3)=plot(1./pointSpacingList,MaxTipForceTotalSc,'k');
legend(mc,{'Angle (node)','Angle (normal)', 'Force (total)'});
title('Mesh Covergence (% of result of iteration 1)')
