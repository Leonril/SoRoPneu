...
%% Rev D
% Notes:
% * Tried to add realistic material properties - fails
% * 
% *  
% * 
%% Keywords
...
k2=2*100;%k_factor; %Bulk modulus
end
...
febio_spec.Material.material{1}.c1=75*(10^(-3))%c1_mat1;
febio_spec.Material.material{1}.m1=2.749%m1_mat1;
% febio_spec.Material.material{1}.c2=c2_mat1;
% febio_spec.Material.material{1}.m2=m2_mat1;
% febio_spec.Material.material{1}.c3=c3_mat1;
% febio_spec.Material.material{1}.m3=m3_mat1;
febio_spec.Material.material{1}.k=100*c1_mat1%k1;
...
febio_spec.Material.material{2}.ATTR.id=2;
febio_spec.Material.material{2}.E=2000;
febio_spec.Material.material{2}.v=1/3;
end
...
axisGeom;
disp('Angle between chamber sets');
...
disp('Bend Angle  (NormalVector Points Time)');
disp(BendingAngle);
