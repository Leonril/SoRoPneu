...
center_of_mass=mean(V(unique(F_top(:)),:));
...
febio_spec.Step.step{2}.Rigid.rigid_constraint{1}.dof='Rz';
...
febio_spec.Step.step{3}.Rigid.rigid_constraint{1}.dof='Rz';
...
febio_spec.Step.step{4}.Rigid.rigid_constraint{1}.dof='Rz';
