...
max_refs=opt_iter*2; %Max reforms (normally set to *2)
...
Chamber_length_elements=6; % no of mesh elements on this length
Chamber_wt_elements=2; % no of mesh elements on this length
Gap_length_elements=3; % no of mesh elements on this length

% y direction 

Side_wall_thickness_elements=2; % no of mesh elements on this length
...
Chamber_height_elements=10; % no of mesh elements on this length (Inclusive of channel parameters)
...
gpatch(Fb,V,Cb,'none',0.5);%normally set transp to 0.5
