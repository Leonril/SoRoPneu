...
Chamber_height=15; %internal height of the chamber (mm)
...
febio_spec.Mesh.Elements{2}.elem.ATTR.id=size(E,1)+(1:1:size(F2,1))'; %Element id's
febio_spec.Mesh.Elements{2}.elem.VAL=F2; %The element matrix
end
